#!/usr/bin/env -S npx babel-node  --no-warnings --env-file=.env
...
//     if(clientsOpened[req.params?.clientid]){
//         
//         console.log(await gptclient.searchForSuitableChats(clientsOpened[req.params?.clientid]))
// //         
// //         const chats = await gptclient.searchForSuitableChats(clientsOpened[req.params?.clientid])
// // /*        console.log(chats)*/
